...
public class ServiceBluetoothLe extends Service {
    ...
    private static boolean mAPAGAR = false;
    ...
    public final static UUID UUID_HM_RX_TX =
            UUID.fromString(ClaseSampleGattAttributes.HM_RX_TX);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onReadRemoteRssi(final BluetoothGatt gatt, final int rssi, final int status) {
            //Log.e(TAG, " RSSI:" + rssi + "db ");
            mClaseControl.pRSSI[0] = rssi;
            try {
                Thread.sleep(2000);
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID_HM_RX_TX.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(UUID.fromString(ClaseSampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
